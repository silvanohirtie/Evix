...
class CommandErrorHandler:
    ...
    async def on_command_error(self, ctx, error):
        ...
        if isinstance(error, ignored):
            ...
            return await ctx.send('❌ Error! You do not have the permission to do that ')

        elif isinstance(error, discord.Forbidden):
            return await ctx.send('❌ Error! I do not have the permission to do that!. Are you sure i have the admin premission?')
